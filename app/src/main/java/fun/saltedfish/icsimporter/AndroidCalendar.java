...
import provider.CalendarContractWrapper.Calendars;
import provider.CalendarContractWrapper.Events;
...
public class AndroidCalendar {
    ...
    public static List<AndroidCalendar> loadAll(ContentResolver resolver) {
        ...
        while (cur.moveToNext()) {
            ...
            fun.saltedfish.icsimporter.AndroidCalendar calendar = new fun.saltedfish.icsimporter.AndroidCalendar();
    ...
    public boolean differsFrom(fun.saltedfish.icsimporter.AndroidCalendar other) {
