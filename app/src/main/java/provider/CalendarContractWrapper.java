...
public final class CalendarContractWrapper {
    ...
    public static final boolean pre15Api = Build.VERSION.SDK_INT < 15;
    public static final boolean pre16Api = Build.VERSION.SDK_INT < 16;
    public static final boolean pre17Api = Build.VERSION.SDK_INT < 17;
    public static final boolean pre18Api = Build.VERSION.SDK_INT < 18;
